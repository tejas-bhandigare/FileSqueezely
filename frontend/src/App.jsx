...
//   return (
//     <div style={{ marginTop: "10px", paddingTop: "0px", paddingLeft: "500px", fontFamily: "Arial",  }}>
//       <h1 style={{paddingLeft:"80px"}}>File Utility Tools</h1>
...
//       {/* Card */}
//       <div style={{ padding: "25px", border: "2.5px solid #702222" }}>
//         {activeTab === "pdf" && (
//           <>
//             <h2>PDF Merge</h2>
...
function App() {
  ...
  const handleImageCompress = async () => {
    ...
    downloadFile(await res.blob(), `compressed_${imageFile.name}`);
  };
  ...
  const handlePdfToWord = async () => {
    ...
    downloadFile(await res.blob(), "converted.docx");
  };

  return (
    <div className="app-wrapper">
      <div className="app-container">
        <h1>Online File Processing Suite</h1>

        {/* Tabs */}
        <div className="tabs">
          <button  onClick={() => setActiveTab("pdf")}> <FaFilePdf /> PDF Merge</button>
          <button onClick={() => setActiveTab("image")}> <FaImage /> Image Compression</button>
          <button onClick={() => setActiveTab("word")}> <FaFileWord /> PDF → Word</button>
        </div>
